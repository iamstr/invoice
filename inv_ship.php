...
<div id="page-wrap">
    ...
    <table id="items">
        <tr>
            <th width="48%"><p style="color:white;">Service Option</p></th>
            <th align="right"><p style="color:white;">Flight/Container Number</p></th>
		...
		<tr class="item-row">
            <td class="description"><?php echo $row->service_options; ?></td>
            <td align="right"><?php echo $row->sfno; ?></td>
